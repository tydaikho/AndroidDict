...
public class FProp extends Activity implements OnClickListener {
    	...
    	Dialog dia = new AlertDialog.Builder(this).setIcon(R.drawable.ico_logo).
    	    ...
    	    setPositiveButton("����",new DialogInterface.OnClickListener() {
    			public void onClick(DialogInterface dia, int which) {
    				...
    				Toast.makeText(FProp.this,SysArgs.save(FProp.this)?"�������óɹ�":"��������ʧ��",Toast.LENGTH_SHORT).show();
    				FProp.this.startActivity(new Intent(FProp.this,Wel.class));
    				((AppMgr) FProp.this.getApplication()).finish();
    			}
    		}).setNeutralButton("Ĭ��",new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dia, int which) {
					SysArgs.init();
					Toast.makeText(FProp.this,SysArgs.save(FProp.this)?"�ָ�Ĭ�����óɹ�":"�ָ�Ĭ������ʧ��",Toast.LENGTH_SHORT).show();
					FProp.this.startActivity(new Intent(FProp.this,Wel.class));
					((AppMgr) FProp.this.getApplication()).finish();
				}
	...
	public void onClick(View v) {
		if(v.getId()==R.id.prop_bg){
			ColorPicker colDia = new ColorPicker(this,color.white,"���ñ���ɫ",new ColorPicker.OnColorChangedListener() {
				@Override
