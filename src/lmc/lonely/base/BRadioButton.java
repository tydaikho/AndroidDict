        ...
        radio_sex.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(RadioGroup group, int checkedId) {
				if(checkedId==radio_nan.getId()){
					radio_res.setText("ѡ����:"+radio_nan.getText().toString());
				}else if(checkedId==radio_nv.getId()){
					radio_res.setText("ѡ����:"+radio_nv.getText().toString());
				}else if(checkedId==radio_no.getId()){
					radio_res.setText("ѡ����:"+radio_no.getText().toString());
				}else if(checkedId==radio_cus.getId()){
					radio_res.setText("ѡ����:"+radio_cus.getText().toString());
				}
			}
		});
        ...
        radio_chs.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				for(int i=0;i<len;i++){
					...
					sb.append(rad.getText().toString()+" ��ѡ��:"+rad.isChecked()+"\n");
				}
				sb.append("��ѡ��ť����:"+len);
