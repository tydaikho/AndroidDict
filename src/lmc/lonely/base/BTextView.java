...
public class BTextView extends Activity {
	...
	private String[]words = new String[]{"abѧ��","abѧϰ","abѧ���","abѧǰ��","abѧϰίԱ","abѧ��","abѧ����","abGoogle","abGoogle Map"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        txt_html.setText(Html.fromHtml("<a href='"+SysConts.down+"'>Դ������</a>"));
        txt_html.setMovementMethod(LinkMovementMethod.getInstance());
        SpannableString ss = new SpannableString("�ַ�����");
        ss.setSpan(new ClickableSpan() {
			@Override
			public void onClick(View widget) {
				BTextView.this.onBackPressed();
			}
		},0,"�ַ�����".length(),Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        txt_span.setText(ss);
        txt_span.setMovementMethod(LinkMovementMethod.getInstance());
        txt_blog.setText("�����߲���:"+SysConts.csdn);
        Linkify.addLinks(txt_blog,Linkify.ALL);
        String img = "ͼƬ����<a href='"+SysConts.csdn+"'><img src='ico_txt'/></a>";
        ...
        txt_format.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				txt_formatres.setText("��ǰʱ��:"+TimeUtils.getTime(TimeUtils.COX));
			}
		});
