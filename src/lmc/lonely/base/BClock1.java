...
public class BClock1 extends Activity implements OnClickListener {
	...
	protected void onActivityResult(int reqCode, int resCode, Intent data) {
		if(reqCode==2){
			if(resCode==RESULT_OK){
				...
				clock_msg.setText("��ʼʱ��:"+start+" ����ʱ��:"+end);
			}
		}
	}
	@Override
	public void onClick(View v) {
		switch(v.getId()){
			...
			case R.id.clock_again:
				...
				clock_chr.setBase(SystemClock.elapsedRealtime());
				break;
			case R.id.clock_format:clock_chr.setFormat("��ʽ��:%s");break;
			...
			case R.id.clock_dia:
				new DatePickerDialog(this,new OnDateSetListener() {
					...
					public void onDateSet(DatePicker view, int year, int month, int day) {
						clock_msg.setText("����ʱ��:"+year+"-"+(month+1)+"-"+day);
					}
		        },2013,0,27).show();
				break;
			default:break;
	...
	private void setTime(){
    	clock_msg.setText("��ǰʱ��:"+clock_date.getYear()+"-"+(clock_date.getMonth()+1)+"-"+
