...
public class Wel extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try{
			...
			File readMe = new File(SysArgs.getAppHome()+"���Ķ�"+SysConts.appName+"ʹ��˵��.txt");
			...
			Toast.makeText(this,"����"+SysConts.appName+"Ӧ��Ŀ¼ʧ��!\n��ȷ�ϰ�װ��SD��",Toast.LENGTH_SHORT).show();
			e.printStackTrace();
		}
    ...
    private void sendMsg(){
		...
		if(alpha<=0){
			...
			if(SysArgs.getMode()==0){
				...
				it.putExtra("title",SysConts.appName+"-��״ģʽ");
